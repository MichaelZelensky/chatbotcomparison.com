...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'This is a comparison between Tidio and Liteed, two popular chatbot solutions.'
    },
    {
      name: 'keywords',
      content: 'tidio vs liteed comparison, chatbot comparison, live chat, ai chatbot, customer support automation'
    }
  ]
})
</script>
