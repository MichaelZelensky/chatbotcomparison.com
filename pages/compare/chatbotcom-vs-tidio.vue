...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'This is a comparison between Tidio and ChatBot.com, two popular chatbot solutions for businesses.'
    },
    {
      name: 'keywords',
      content: 'tidio vs chatbotcom comparison, chatbot comparison, live chat, ai chatbot, customer support automation'
    }
  ]
})
</script>
