...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'This is a comparison between ChatBot.com and LiveAgent, two popular customer support solutions.'
    },
    {
      name: 'keywords',
      content: 'chatbotcom vs liveagent comparison, chatbot comparison, live chat, ai chatbot, customer support automation'
    }
  ]
})
</script>
