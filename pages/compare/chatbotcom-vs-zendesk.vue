...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'This is a comparison between ChatBot.com and Zendesk, two leading chatbot solutions.'
    },
    {
      name: 'keywords',
      content: 'chatbotcom vs zendesk comparison, chatbot comparison, live chat, ai chatbot, customer support automation'
    }
  ]
})
</script>
