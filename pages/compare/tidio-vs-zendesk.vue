...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'This is a comparison between Tidio and Zendesk, two popular customer support platforms.'
    },
    {
      name: 'keywords',
      content: 'tidio vs zendesk comparison, chatbot comparison, live chat, ai chatbot, customer support automation'
    }
  ]
})
</script>
